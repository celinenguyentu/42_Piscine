...
/*   Updated: 2024/03/10 15:36:43 by cnguyen-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	char	*addr1;
	char	addr2[] = {47, 48, 126, 127, 128, 129, 130}; 

	addr1 = "Bonjour les aminches\t\n\tc\a est fou\ttout\tce qu on //replace
		peut faire avec\t\n\tprint_memory\n\n\n\tlol.lol\n "; //buffsize92
	ft_print_memory(addr1, 92);
	ft_print_memory(addr2, 255);
	return (0);
}
*/