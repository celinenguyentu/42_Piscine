...
/*   Updated: 2024/02/15 07:00:12 by cnguyen-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	printf("-424242 in binary : %d\n", ft_atoi_base(nbr1, binaire));
	printf("-424242 in hexadecimal : %d\n", ft_atoi_base(nbr3, hexadecimal));
	printf("-424242 in poneyvif : %d\n", ft_atoi_base(nbr2, poneyvif));
	printf("IntMin in hexadecimal : %d\n", ft_atoi_base(intmin, hexadecimal));
	printf("IntMax in octal : %d\n", ft_atoi_base(intmax, octal));
	//printf("Length of string  %d", ft_find('c', &"1234567890123456789012"[4]));
	return (0);
}
*/
